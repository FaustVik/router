...
{
    public function index(): void { echo "Список пользователей"; }
    public function show(): void { echo "Показать пользователя"; }
    public function create(): void { echo "Создать пользователя"; }
}

class AdminController
{
    public function dashboard(): void { echo "Админ панель"; }
    public function users(): void { echo "Управление пользователями"; }
}
